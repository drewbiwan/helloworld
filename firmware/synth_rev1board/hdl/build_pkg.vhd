...
package build_pkg is
    constant CONFIGURATION_NAME_C   : integer := "rev1board;
    ...
    constant BUILD_TIME_EPOCH_C     : STD_LOGIC_VECTOR(31 downto 0) := x"618AE124";
    constant BRANCH_STRING_C        : string := "refs/heads/main";
    constant COMMIT_OID_C           : STD_LOGIC_VECTOR(159 downto 0) := x"7ebf0e482f7fc86d73304ebf04334409584a377d";
